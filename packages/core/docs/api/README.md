...
- [createQResultError](functions/createQResultError.md)
- [createQResultSuccess](functions/createQResultSuccess.md)
- [createSqlSpan](functions/createSqlSpan.md)

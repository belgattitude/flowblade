...
If you want to consume the package without intermediary build step (no yarn build, no yarn watch...), you can add a tsconfig path alias in the consumer app/package .
